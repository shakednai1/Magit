...
public class CommitNodeController extends BaseController {
    ...
    class CommitDiffEvent implements EventHandler<ActionEvent> {
    ...
    class CommitFSEvent implements EventHandler<ActionEvent> {
        public void handle(ActionEvent e) {
    ...
    public void setCommitData(CommitData commitData){
        ...
        setCommitMessage(commitData.getMessage());
        setCommitter(commitData.getCommitter());
        setCommitTimeStamp(commitData.getCommitTime());
        setPointingBranches(commitData.getPointingBranchNames());

        setContextMenu();
        setCommitSha1(commitData.getSha1());
        setPrevCommitSha1(commitData.getPreviousCommitSha1(), commitData.getSecondPreviousCommitSha1());
    ...
    public void setContextMenu(){
        ...
        item1.setOnAction(new CommitDiffEvent());

        MenuItem item2 = new MenuItem("Show File System");
        item2.setOnAction(new CommitFSEvent());

        MenuItem item3 = new MenuItem("Get Commit Details");
        item3.setOnAction(new CommitDetailsEvent());
